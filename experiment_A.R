...
# periodic_result = periodic_based_prediction(data, dt, threshold_name, threshold_mode, index, init_threshold_value, training_percentage)

# quatratic_result = quatratic_based_prediction(data, dt, threshold_name, threshold_mode, index, init_threshold_value, training_percentage)\

# prediction_result_soft = arima_based_prediction(data, dt, threshold_name, threshold_mode = "soft", index, init_threshold_value, training_percentage)
